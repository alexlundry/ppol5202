...
anim_save("plots/gapminder2.gif", animation = p3)
```
...
anim_save("plots/gapminder3.gif", animation = p4)
```
...
anim_save("plots/nvidia.gif", animation = p6)
```
...
anim_save("plots/gapminder5.gif", animation = p7)
```
...
anim_save("plots/gapminder6.gif", animation = p8)
```
